...
export const popupEditNameInput = document.querySelector(
  ".popup-edit-profile__input_text_name"
);
export const popupEditCaptionInput = document.querySelector(
  ".popup-edit-profile__input_text_caption"
);
...
export const popupFullImage = document.querySelector(
  ".popup-full-image__image"
);
export const popupFullTitle = document.querySelector(
  ".popup-full-image__title"
);

export const buttonEditAvatar = document.querySelector(
  ".profile__avatar-button"
);
export const popupEditAvatarInput = document.querySelector(
  ".popup-edit-avatar__input_text_caption"
);
